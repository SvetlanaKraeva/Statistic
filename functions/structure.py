...
class Structure_of_measures:
    ...
    def out(self, num):
        list_of_measures = []
        list_of_measures.append(self.mean[num])
        list_of_measures.append(self.median[num])
        list_of_measures.append(self.r[num])
        list_of_measures.append(self.trimmed[num])
        list_of_measures.append(self.q[num])
        #list_of_measures.append(self.sq[num])
        #list_of_measures.append(self.ab[num])
        #list_of_measures.append(self.range[num])
        #list_of_measures.append(self.iqr[num])
        #list_of_measures.append(self.mad[num])
